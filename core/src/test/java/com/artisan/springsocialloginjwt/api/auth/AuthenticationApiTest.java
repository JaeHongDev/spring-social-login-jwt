...
public class AuthenticationApiTest {
    ...
    @Test
    @WithMockUser
    void getMeUserTest() throws Exception{
        authenticationService.signup(new SignupRequest("id","password","",""));
        var tokenResponse = authenticationService.login(new LoginRequest("id","password"));
